        ...
        <section className="sm:px-5 sm:mb-5 border-b-2 border-gray-100 sm:border-none">
          <Card className="space-y-5">
            <div className="stat border rounded">
              ...
              <div className="stat-title">Total Jurusan</div>
              <div className="stat-value text-secondary">{getStats?.majors?.length}</div>
            </div>
            <div className="stat border rounded">
              ...
              <div className="stat-value text-neutral">{getStats?.materials?.length}</div>
            </div>
            <div className="stat border rounded">
